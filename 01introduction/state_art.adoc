...
En este estudio, Yi-Shin Chen propone un sistema denominado *TweoLocator* que funciona como un _framework_ que, a través de diferentes etapas, asegura ofrecer unos resultados altamente fiables acerca de la localización de un usuario en Twitter.
