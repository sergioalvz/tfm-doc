...
Para los siguientes ejemplos se ha tomado como umbral el valor *0.5*, el cual demuestra tener un buen comportamiento en la relación acierto - exhaustividad.
